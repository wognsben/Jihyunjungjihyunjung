...
export const Text = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-foreground selection:text-background relative">
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 pt-24 md:pt-32 pb-24 flex flex-col md:flex-row gap-8 md:gap-24 relative">
        ...
        <motion.div 
            ...
            className={`
               md:w-1/4 lg:w-1/5 md:h-[calc(100vh-8rem)] 
